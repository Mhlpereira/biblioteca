...
export class Inicial1769362822009 implements MigrationInterface {
    name = 'Inicial1769362822009'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`client\` (\`id\` varchar(26) NOT NULL, \`cpf\` varchar(11) NOT NULL, \`name\` varchar(255) NOT NULL, \`last_name\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`active\` tinyint NOT NULL DEFAULT 1, \`role\` varchar(255) NOT NULL DEFAULT 'USER', \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_9921dca81551c93e5a459ef03c\` (\`cpf\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
